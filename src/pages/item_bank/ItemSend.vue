    ...
    methods: {
      ...
      subject() {
        if (this.$route.params.topicId) {
          ...
          this.axios.get('http://tk.exejk12.com:8787//index.php?s=App&uid=644&token=513be51f05f85c2e3fc708be5431216d&m=Questions&a=loadQuestions&id=' + ary).then(response => {
