  ...
  <div class="all">
            ...
            <el-submenu v-for="(i,n) in rendering" :index="(n+1+'')" :key="n">
              ...
              <el-menu-item-group>
                <el-menu-item index="1-1" v-for="(q,m) in i.children" :key="m">
                  <span style="margin-left: 0.41rem" @click="take(q)">{{q.label}}</span>
                </el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
          ...
          <el-row class="answer_card">
            <el-col :span="24">
              <div class="grid-content bg-purple-dark above">
                ...
                <div @click="qq" v-for="(item,n) in optionCard" class="optionBtn">
                  <el-button
                    type="primary"
                    class="optionNum"
    ...
    <div class="upload_eject">
      <el-dialog :visible.sync="outerVisible">
        <el-dialog width="30%" :visible.sync="innerVisible" append-to-body></el-dialog>
...
export default {
  ...
  methods: {
    ...
    queryFrame() {
      this.axios
        .get(
          "/index.php?s=App&m=Dayly&a=book_info&uid=644&token=513be51f05f85c2e3fc708be5431216d"
        )
        .then(response => {
    ...
    linkage() {
      this.axios
        .get(
          "/index.php?s=App&uid=644&token=513be51f05f85c2e3fc708be5431216d&m=Dayly&a=query_info&id=" +
            this.titles
        )
        .then(response => {
          this.rendering = [];
