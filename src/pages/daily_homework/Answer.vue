  ...
  export default {
        ...
        methods: {
            ...
            editTopic(item) {
                ...
                console.log(item.children[0]['answer'].length);
                this.form.name = item.title;
                this.form.num = item.children.length;
                this.form.value = item.children[0]['num'];
                this.form.selectNum = item.children[0]['answer'].length;
            ...
            getSend() {
              ...
              let num = [
                ...
                this.axios.post('http://tk.exejk12.com:8787/index.php?s=App&m=Dayly&a=submit_dayly&uid=644&token=513be51f05f85c2e3fc708be5431216d',{info:num,id:213},).then(response=>{
                    console.log(info);
